...
start = clock();
    ...
    milliseconds = 1000.0 * (end - start) / CLOCKS_PER_SEC;For our parallel implementations, we conducted our tests using Google Colab with a T4 GPU. This environment provided us with the necessary computational power to run our CUDA C implementation efficiently.
